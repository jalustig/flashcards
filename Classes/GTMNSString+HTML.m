...
// Taken from http://unicode-table.com/en/
// Ordered by uchar lowest to highest for bsearching
static HTMLEscapeMap gMathJaxEscapeMap[] = {
...
- (NSString *)gtm_stringByEscapingForMathJax {
    return [self gtm_stringByEscapingHTMLUsingTable:gMathJaxEscapeMap
                                             ofSize:sizeof(gMathJaxEscapeMap)
                                    escapingUnicode:NO];
}
...
- (NSString *)gtm_stringByUnescapingFromMathJax {
