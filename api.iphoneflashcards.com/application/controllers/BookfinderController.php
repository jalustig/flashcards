...
class BookfinderController extends Zend_Controller_Action
{
    public $db;
    ...
    public function indexAction() {
        ...
        <table>
            <tr>
                <th>Book Name:</th>
                <td><input name="book_name" style="width:400px;" /></td>
            </tr>
            <tr>
                <th>URL:</th>
                <td><input name="url" style="width:400px;" /></td>
            </tr>
            <tr>
                <th>URL:</th>
                <td><input name="url2" style="width:400px;" /></td>
            </tr>
            <tr>
                <th>&nbsp;</th>
    ...
    <!--    <iframe src="bookfinder/buffer/?url=<?php echo urlencode("http://www.bookfinder.com/"); ?>" style="width:100%; height: 80%;"></iframe>
    -->
        <hr>
        <?php
